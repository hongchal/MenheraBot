...
function Label({ children }: { children: React.ReactNode }) {
  return (
    <p style={{
      ...
      color: "#000", margin: "0 0 10px", textTransform: "uppercase",
    }}>{children}</p>
  );
}
    ...
    <div style={{
      ...
      <div style={{ borderBottom: LINE, padding: "40px 24px 20px" }}>
        <div style={{ maxWidth: 480, margin: "0 auto" }}>
          <p style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.15em", margin: "0 0 8px", color: "#999", textTransform: "uppercase" }}>
            Menhera Bot
          </p>
          <h1 style={{ fontSize: 32, fontWeight: 700, letterSpacing: -0.5, margin: 0, lineHeight: 1.2 }}>
            그 사람 행동,<br />분석해보자
          </h1>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 480, margin: "0 auto", padding: "0 24px 80px" }}>
        ...
        <div style={{ borderBottom: LINE, padding: "20px 0" }}>
          ...
          {relation === "직접입력" && (
            <input
              ...
              style={{
                marginTop: 10, width: "100%", border: "none", borderBottom: LINE,
                padding: "8px 0", color: "#000", fontFamily: "inherit",
                fontSize: 14, outline: "none", boxSizing: "border-box", background: "transparent",
              }}
            />
          )}
        </div>
        ...
        <div style={{ borderBottom: LINE, padding: "20px 0" }}>
          ...
          <textarea
            ...
            rows={4}
            style={{
              width: "100%", border: "none", borderBottom: LINE,
              padding: "0 0 8px", color: "#000", fontFamily: "inherit",
              fontSize: 15, lineHeight: 1.7, resize: "none",
              outline: "none", boxSizing: "border-box", background: "transparent",
            }}
          />
        </div>
        ...
        <div style={{ padding: "20px 0" }}>
          <button
            ...
            style={{
              ...
              border: `1px solid ${loading || !situation.trim() ? "#ccc" : ACCENT}`,
          ...
          {error && (
            <p style={{ fontSize: 12, color: ACCENT, marginTop: 8, textAlign: "center" }}>{error}</p>
          )}
        </div>
        ...
        {structured && (
          <div ref={resultRef}>
            <div style={{ borderTop: "2px solid #000", paddingTop: 20, marginTop: 4 }}>
              ...
              {visibleCount >= structured.messages.length && structured.emotion && (
                <div style={{ marginTop: 8 }}>
                  ...
                  <p style={{ fontSize: 14, lineHeight: 1.9, margin: "0 0 16px", color: "#333" }}>
                  ...
                  <div style={{ borderLeft: `3px solid ${ACCENT}`, paddingLeft: 14, marginBottom: 16 }}>
                    ...
                    <p style={{ fontSize: 14, lineHeight: 1.7, margin: 0, fontWeight: 600, color: "#000" }}>
                  ...
                  <div style={{ borderTop: "1px solid #f0f0f0", paddingTop: 14 }}>
                    ...
                    <p style={{ fontSize: 13, lineHeight: 1.9, margin: 0, color: "#666" }}>
